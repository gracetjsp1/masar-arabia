...
$(function () {
    ...
    $('.product_tab_navigation a').on('click', function (e) {
    e.preventDefault();

    var $href = $(this).attr('href');

    $('.product_tab_navigation a').removeClass('active');
    $(this).addClass('active');

    $('.product_page_content_inner .tab-pane').removeClass('active show');
    $('.product_page_content_inner ' + $href).addClass('active show');
});
});